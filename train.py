...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', "--mark", default='round4_device1')
    
    parser.add_argument('-md', "--mode", default='train') # real_time, train, test
    ...
    parser.add_argument('--peak_type', default = "simple") # librosa, simple, thresh
    ...
    # eight fold validation num
    parser.add_argument("--folder", type=int, default = 0, help="-1,0,1,2,3,4,5,6,7") 
    ...
    # test mode, small training epoch
